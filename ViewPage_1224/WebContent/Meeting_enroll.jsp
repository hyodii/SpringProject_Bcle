...
<body>
	...
	<form action="beeinsert.action" method="post" id="beeForm">
		...
		<div class="upper">
			...
			</select> 모임 제목<input type="text" id="title" name="title" required="required"> 주최자 : 글작성자닉네임 받아오기
		</div>
		<div class="bottom">
			<div class="intro">
				<h3>모임소개</h3>
			...
			<div class="bottom2">
				<div class="left">
					...
					<br></br> 참가비 <input type="text" id="fee" name="fee" required="required"> 
					...
					인원<input type="number" id="min" name="min" placeholder="최소인원" required="required"> - 
							<input type="number" id="max" name="max" placeholder="최대인원" required="required"><br>
