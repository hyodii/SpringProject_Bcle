...
-->
	...
	<div style="float: left; margin : 5vh 30vh 3vh 18%;">
			...
			onclick="location.href='beeinsertform.action?id='">모임개설</button>
	...
	<div class="contents">
		...
		<c:forEach  var="bee" items="${beeList }">
			<a href="beedetailpage.action?beeId=${bee.beeId}" style="text-decoration: none;">
			<div class="row g-0">
				<div class="col-md-4">
				...
				<div class="col-md-8">
					<div class="card-body">
						...
						<p class="card-text">인원수 : (${bee.reqCnt } / ${bee.max }) 이것도 나중에 모임일 지나면 불참인원 빼야 함</p>
