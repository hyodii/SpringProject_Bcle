...
{
display:inline-block; padding: 20px; background: white; color: #0B5FA5; font-size: 14pt;cursor: pointer;
border: 1px solid #0B5FA5; border-top-left-radius: .25rem;border-top-right-radius: .25rem;
}
input[type="radio"]:checked +label {
	background: #0B5FA5; color: white; border: 1px solid #0B5FA5; border-top-left-radius: .25rem;border-top-right-radius: .25rem;
}

.conbox {width: 100%; height: 100%; margin: 0 auto;display: none;}
				...
				<li>타이틀: ${clubInfo.title }</li>
						<li>개설일: ${fn:substring(clubInfo.bdate, 0, 10)}</li>
								<li>인원수: </li>
										...
										<li><a href="beecalendarlist.action?cid=${clubInfo.cid }">나중에 지울 부분! 캘린더로 가기</a></li>
		</ul>
		</div>
...
<div class="tab_content">
	...
	<label for="tab01"  style="margin-left: 30vh;">기본정보</label>
	<input type="radio"  name="tabmenu" id="tab02">
	<label for="tab02">캘린더</label>
	<input type="radio"  name="tabmenu" id="tab03">
	<label for="tab03">게시판</label>
	<input type="radio"  name="tabmenu" id="tab04">
	<label for="tab04">회계</label>
	<input type="radio"  name="tabmenu" id="tab05">
	<label for="tab05">사진첩</label>
	<input type="radio"  name="tabmenu" id="tab06">
	<label for="tab06">회의</label>
	<input type="radio"  name="tabmenu" id="tab07">
	<label for="tab07">결산</label>
	
	<div class="conbox con1"></div>
	<div class="conbox con2"><c:import url="/beecalendarlist.action?cid=${clubInfo.cid }"></c:import></div>
	<div class="conbox con3"><c:import url="/beenoticelist.action"></c:import></div>
</div>
