...
public class MemberInfoDAO implements IMemberInfoDAO
{
	...
	pstmt.setString(1, memberInfo.getCategory1());
	pstmt.setString(2, memberInfo.getMemberName());
	pstmt.setString(3, memberInfo.getSsn());
	pstmt.setString(4, memberInfo.getEmail());
	pstmt.setString(5, memberInfo.getTel());
	pstmt.setString(6, memberInfo.getPwd());
	pstmt.setString(7, memberInfo.getNickname());
	pstmt.setString(8, memberInfo.getUrl());
	pstmt.setString(9, memberInfo.getRegionId1());
	pstmt.setString(10, memberInfo.getUserId());
	pstmt.setString(11, memberInfo.getCategory2());
	pstmt.setString(12, memberInfo.getCategory3());
	pstmt.setString(13, memberInfo.getCategory4());
	pstmt.setString(14, memberInfo.getCategory5());
	pstmt.setString(15, memberInfo.getRegionId2());
	pstmt.setString(16, memberInfo.getRegionId3());
    */
