		...
		<form action="">
			...
			<div class="id form-group col-md-6 col-sm-6">
				<label for="userId">아이디*
					<input type="text" id="userId" placeholder="아이디를 입력하세요." required="required" class="form-control"/>
					<input type="button" value="중복확인">
					<span id="err" style="display: none; color: red; font-size: small;">아이디를 입력해주세요.</span><br>
					<span id="err" style="display: none; color: red; font-size: small;">다른 아이디를 사용하세요.</span><br>
				</label>
			</div>
			<div class="form-group col-md-6 col-sm-6">
